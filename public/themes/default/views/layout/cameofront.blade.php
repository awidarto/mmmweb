...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/todc-bootstrap/css/todc-bootstrap.css">
...
<body>
    ...
    {{ HTML::script('bootstrap-material-design/scripts/material.js') }}
    {{ HTML::script('bootstrap-material-design/scripts/ripples.js') }}
