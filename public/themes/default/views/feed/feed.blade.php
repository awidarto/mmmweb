...
@section('content')
    ...
    <div id="feed">
        <section class="panel no-border bg-success">
            <div class="panel-heading no-border">
                ...
                <h5 class="text-white pd">Dangdut Progressive 1
                    <b>Playlist shared by {{ Auth::user()->fullname }}</b>
                </h5>
            </div>
            <div class="panel-body bg-white">
    ...
    <section class="panel no-border">
        ...
        <div class="panel-body no-padding">
            ...
            <div class="pd-md">
                Peter Capaldi, Matt Smith, David Tennant, Christopher Eccleston and 6 others hate the Dalek.
                <div class="clearfix mg-t-md">
                    <img src="{{ URL::to('cameo')}}/img/face3.jpg" class="avatar avatar-sm img-circle pull-left mg-r-md" alt="">
