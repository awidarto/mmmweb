<div data-toggle="gridalicious" data-gridalicious-width="160" data-gridalicious-gutter="25">
            ...
            @foreach($media as $m)
                <div class="widget widget-heading-simple widget-body-white widget-pinterest">
                    <div class="widget-body padding-none">
                        <a href="#" data-source="{{ $m->defaultmedia['fileurl'] }}" data-title="{{ $m->title }}" data-mediaid="{{ $m->_id }}"
                         class="thumb music-link" >
