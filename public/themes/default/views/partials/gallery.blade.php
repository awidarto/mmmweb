            ...
            @foreach($media as $m)
                <div class="widget widget-heading-simple widget-body-white widget-pinterest">
                    <div class="widget-body padding-none">
                        <a href="" data-source="{{ $m->defaultmedia['fileurl'] }}" data-title="{{ $m->title }}" data-mediaid="{{ $m->_id }}" data-mediatype="{{ $m->mediatype }}" data-poster="{{ $m->defaultpic['medium_url'] }}" class="thumb music-link" >
