...
class InvoicesController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            ...
            array('Due Date',array('search'=>true,'sort'=>true, 'attr'=>array('class'=>'span2'))),
            array('Addressee',array('search'=>true,'sort'=>true ,'attr'=>array('class'=>'span2'))),
            array('Amount',array('search'=>true,'sort'=>true, 'select'=>Prefs::getOutlet()->OutletToSelection('name','name') )),
        ...
        $this->additional_filter = View::make('invoices.addfilter')->render();
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            ...
            array('invoiceNumber',array('kind'=>'text','query'=>'like','pos'=>'both','attr'=>array('class'=>'expander'),'show'=>true)),
            array('dateReleased',array('kind'=>'text','query'=>'like','pos'=>'after','callback'=>'shortunit','attr'=>array('class'=>'expander'),'show'=>true)),
            array('dateDue',array('kind'=>'text','callback'=>'dispBar', 'query'=>'like','pos'=>'both','show'=>true)),
